      ...
      - generic [ref=e44]:
        ...
        - generic [ref=e128]:
          ...
          - generic [ref=e201]:
            - generic [ref=e202]:
              - generic [ref=e203]:
                - generic [ref=e205]: Awaiting approval
                - generic [ref=e206]: Dev → QA
              - generic [ref=e207]: Mar 15, 11:24 PM
            - generic [ref=e208]:
              - text: Submitted by
              - strong [ref=e209]: Alice Chen
            - generic [ref=e211]: alter_ddls/001_initial_schema.sql
            - link "View GitHub PR →" [ref=e212] [cursor=pointer]:
              - /url: https://github.com/dsaipg/snowdeploy-sample/pull/3
            - generic [ref=e214]: Waiting for a teammate to approve
```