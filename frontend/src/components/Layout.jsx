...
const styles = {
  shell: { display: 'flex', flexDirection: 'column', height: '100vh', background: '#0d0e14' },
  topbar: {
    display: 'flex',
    alignItems: 'center',
    gap: '16px',
  ...
  teamBadge: {
    ...
    background: '#1a3a2a', border: '1px solid #22c55e',
  ...
  userLabel: { fontSize: '13px', color: '#94a3b8' },
  helpBtn: {
  ...
  navTabActive: { color: '#f1f5f9', borderBottomColor: '#6366f1' },
